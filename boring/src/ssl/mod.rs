...
impl SslCurve {
    ...
    //
    // TODO[glendc]: this is available now, but not yet sure how to use it,
    // as such it is still in here
    #[allow(dead_code)]
...
impl SslContextBuilder {
    ...
    /// GREASE and fallback SCSV values may still be added around this list.
    ///
